...
- Create and test detection rules against Facebook, X/Twitter, Snapchat and Threads
- Add automated tests for acessibility working checking.
- Add a stable, user-facing release build and signed APK process.

## Planned features

- Most of Artificial Dumbness surfaces including buttons and others dissapear instead just closing when trying entering.
- App configuration Tab to choose Themes White/Black and Follow OS & Choose Language
