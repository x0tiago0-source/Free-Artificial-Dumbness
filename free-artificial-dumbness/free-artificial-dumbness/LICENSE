...
**Copyright (C) 2026 Tiago Duarte**

---

## Overview

The **Free Artificial Dumbness** project is free software: you can redistribute it and/or modify it under the terms of the GNU General Public License as published by the Free Software Foundation, either version 3 of the License, or (at your option) any later version.

The **Free Artificial Dumbness** project is distributed in the hope that it will be useful, but **WITHOUT ANY WARRANTY**; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the GNU General Public License for more details.
...
- [Trademark and Identity](#trademark-and-identity)
- [Official Version Policy](#official-version-policy)
...
- Allow users to modify and redistribute the code
...
## Official Version Policy

The intention of the official project is to maintain core features available without paywall and promote community development.

### Core Principles

1. **Free and Open Source**: The official version will always be distributed under GPLv3
2. **Community Driven**: Community contributions are welcomed and valued
3. **Transparency**: All changes and decisions are documented
...
The complete legal text of the GNU General Public License, version 3, is available at:

<https://www.gnu.org/licenses/gpl-3.0.html>

If there is any difference between this summary and the full GPLv3 text, the full GPLv3 text always prevails.

### Quick Links

- [GPL-3.0 at FSF](https://www.gnu.org/licenses/gpl-3.0.html)
- [GPL-3.0 at SPDX](https://spdx.org/licenses/GPL-3.0-or-later.html)
- [Understanding GPL](https://www.gnu.org/licenses/gpl-faq.en.html)
